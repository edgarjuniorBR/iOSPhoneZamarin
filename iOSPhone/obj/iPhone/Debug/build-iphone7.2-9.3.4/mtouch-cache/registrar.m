...
static NSInteger native_to_managed_trampoline_12 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UITableView * p0, NSInteger p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
static UITableViewCell * native_to_managed_trampoline_13 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UITableView * p0, NSIndexPath * p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
static void native_to_managed_trampoline_14 (id self, SEL _cmd, MonoMethod **managed_method_ptr, NSObject * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	if (mono_domain_get () == NULL)
...
@interface ViewController : UIViewController {
	...
	@property (nonatomic, assign) UIButton * CallHistoryButton;
	...
	-(UIButton *) CallHistoryButton;
	-(void) setCallHistoryButton:(UIButton *)p0;
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "get_CallHistoryButton");
	}

	-(void) setCallHistoryButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "iOSPhone.ViewController, iOSPhone", "set_CallHistoryButton");
	}
...
@interface iOSPhone_CallHistoryController_CallHistoryDataSource : NSObject<UIScrollViewDelegate> {
	XamarinObject __monoObjectGCHandle;
}
	-(void) release;
	-(id) retain;
	...
	-(BOOL) conformsToProtocol:(void *)p0;
@end
@implementation iOSPhone_CallHistoryController_CallHistoryDataSource { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_12 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "System.nint, Xamarin.iOS", "iOSPhone.CallHistoryController+CallHistoryDataSource, iOSPhone", "RowsInSection");
	}

	-(UITableViewCell *) tableView:(UITableView *)p0 cellForRowAtIndexPath:(NSIndexPath *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_13 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS", "Foundation.NSIndexPath, Xamarin.iOS", "iOSPhone.CallHistoryController+CallHistoryDataSource, iOSPhone", "GetCell");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"iOSPhone_CallHistoryController_CallHistoryDataSource", "iOSPhone.CallHistoryController+CallHistoryDataSource, iOSPhone", NULL },
		{"CallHistoryController", "iOSPhone.CallHistoryController, iOSPhone", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [17].handle = objc_getClass ("UIScrollView");
	__xamarin_class_map [18].handle = objc_getClass ("UITableView");
	__xamarin_class_map [19].handle = objc_getClass ("UITableViewCell");
	__xamarin_class_map [20].handle = objc_getClass ("UITextField");
	...
	__xamarin_class_map [25].handle = objc_getClass ("UILocalNotification");
	...
	__xamarin_class_map [31].handle = objc_getClass ("UIPress");
	__xamarin_class_map [32].handle = objc_getClass ("NSUserActivity");
	__xamarin_class_map [33].handle = objc_getClass ("UIStoryboard");
	...
	__xamarin_class_map [40].handle = objc_getClass ("UITouch");
	...
	__xamarin_class_map [43].handle = objc_getClass ("UIAlertAction");
	__xamarin_class_map [44].handle = objc_getClass ("UIAlertController");
	...
	__xamarin_class_map [52].handle = [iOSPhone_CallHistoryController_CallHistoryDataSource class];
	__xamarin_class_map [53].handle = [CallHistoryController class];
	...
	__xamarin_class_map [58].handle = objc_getClass ("UIKit_UIScrollView__UIScrollViewDelegate");
