...
static void native_to_managed_trampoline_12 (id self, SEL _cmd, MonoMethod **managed_method_ptr, NSObject * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	if (mono_domain_get () == NULL)
...
@implementation AppDelegate { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, "iOSPhone.AppDelegate, iOSPhone", "get_Window");
	}

	-(void) setWindow:(UIWindow *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "set_Window");
	}

	-(BOOL) application:(UIApplication *)p0 didFinishLaunchingWithOptions:(NSDictionary *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, p1, "UIKit.UIApplication, Xamarin.iOS", "Foundation.NSDictionary, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "WillEnterForeground");
	}

	-(void) applicationDidBecomeActive:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "OnActivated");
	}

	-(void) applicationWillTerminate:(UIApplication *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS", "iOSPhone.AppDelegate, iOSPhone", "WillTerminate");
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_7 (self, _cmd, &managed_method, "iOSPhone.AppDelegate, iOSPhone", ".ctor", &call_super);
		if (call_super && rv) {
...
@interface ViewController : UIViewController {
	...
	@property (nonatomic, assign) UIButton * TranslateButton;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
	-(UIButton *) CallButton;
	-(void) setCallButton:(UIButton *)p0;
	-(UITextField *) PhoneNumberText;
	-(void) setPhoneNumberText:(UITextField *)p0;
	-(UIButton *) TranslateButton;
	-(void) setTranslateButton:(UIButton *)p0;
	-(void) viewDidLoad;
...
@implementation ViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "get_CallButton");
	}

	-(void) setCallButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "iOSPhone.ViewController, iOSPhone", "set_CallButton");
	}

	-(UITextField *) PhoneNumberText
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_10 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "get_PhoneNumberText");
	}

	-(void) setPhoneNumberText:(UITextField *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_11 (self, _cmd, &managed_method, p0, "UIKit.UITextField, Xamarin.iOS", "iOSPhone.ViewController, iOSPhone", "set_PhoneNumberText");
	}

	-(UIButton *) TranslateButton
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "get_TranslateButton");
	}

	-(void) setTranslateButton:(UIButton *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "UIKit.UIButton, Xamarin.iOS", "iOSPhone.ViewController, iOSPhone", "set_TranslateButton");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "ViewDidLoad");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_1 (self, _cmd, &managed_method, "iOSPhone.ViewController, iOSPhone", "DidReceiveMemoryWarning");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "iOSPhone.AppDelegate, iOSPhone", NULL },
		{"ViewController", "iOSPhone.ViewController, iOSPhone", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [14].handle = objc_getClass ("UITextField");
	...
	__xamarin_class_map [24].handle = objc_getClass ("NSUserActivity");
	__xamarin_class_map [25].handle = objc_getClass ("NSException");
	__xamarin_class_map [26].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [27].handle = objc_getClass ("UITextRange");
	__xamarin_class_map [28].handle = objc_getClass ("UITextSelectionRect");
	...
	__xamarin_class_map [31].handle = objc_getClass ("UIAlertAction");
	__xamarin_class_map [32].handle = objc_getClass ("UIAlertController");
	...
	__xamarin_class_map [35].handle = objc_getClass ("NSData");
	__xamarin_class_map [36].handle = objc_getClass ("NSDictionary");
